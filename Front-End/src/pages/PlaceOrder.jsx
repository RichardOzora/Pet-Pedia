...
function PlaceOrder(){
    ...
    return(
        <div className="flex flex-col sm:flex-row justify-between gap-4 sm:pt-14 min-h-[80vh] border-t px-0 sm:px-[3vw] md:px-[5vw] lg:px-[7vw] mt-16">
            <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
                <div className="text-xl sm:text-2xl my-3">
                    <Title text1={"DELIVERY"} text2={"INFORMARION"}/>                
                </div>
                ...
                <div className="mt-12">
                    ...
                    <div className="flex gap-3 flex-col lg:flex-row">
                        <div onClick={() => setMethod("stripe")} className="flex items-center gap-3 border p-2 px-3 cursor-pointer">
                            ...
                            <img className="h-5 mx-4" src={assets.bca_logo} alt=""/>
                        </div>
                        <div onClick={() => setMethod("razorpay")}  className="flex items-center gap-3 border p-2 px-3 cursor-pointer">
                            <p className={`min-w-3.5 h-3.5 border rounded-full ${method === "razorpay" ? "bg-green-400" : ""}`}></p>
                            <img className="h-5 mx-4" src={assets.ovo_logo} alt=""/>
                        </div>
                    ...
                    <div className="w-full text-end mt-8">
                        <button onClick={() => navigate("/orders")} className="bg-black text-white px-16 py-3 text-sm">PLACAE ORDER</button>
                    </div>
                </div>
            </div>
        </div>
