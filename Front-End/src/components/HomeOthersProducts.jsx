...
function HomeOthersProducts(){

    const {otherProducts} = useContext(ShopContext);
    const [homeProducts, setHomeProducts] = useState([]);

    useEffect(() => {
        setHomeProducts(otherProducts.slice(0, 10));
    }, [otherProducts])

    return(
        <div className="my-10 px-0 sm:px-[3vw] md:px-[5vw] lg:px-[7vw]">
            <div className="text-center py-8 text-3xl">
                <Title2 text1={"TRENDING TOYS"}  text2={"& OTHERS"}/>
            </div> 
...
export default HomeOthersProducts